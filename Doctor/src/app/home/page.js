...
// Use dynamic import for the Slider component
...
const HomePage = () => {
    // ... all your component code remains the same ...
    const features = [
    ...
    const testimonials = [
        {
        name: "John Doe",
        text: "WellMindZone has revolutionized how I manage my healthcare. It's so easy to use!",
        image: "https://randomuser.me/api/portraits/men/32.jpg",
        },
        {
        name: "Jane Smith",
        text: "I love how I can access all my medical information in one place. Great job, WellMindZone!",
        image: "https://randomuser.me/api/portraits/women/44.jpg",
        },
        {
        name: "Mike Johnson",
        text: "Booking appointments has never been easier. WellMindZone is a game-changer!",
        image: "https://randomuser.me/api/portraits/men/22.jpg",
        },
        {
        name: "Emily Davis",
        text: "The staff is incredibly helpful and caring. I highly recommend WellMindZone!",
        ...
        {
        name: "Mary Brown",
        text: "I appreciate the convenience of managing everything online. Thank you, WellMindZone!",
