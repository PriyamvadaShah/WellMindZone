...
const Footer = () => {
  ...
  return (
    <footer className="bg-green-600 text-light font-main">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-accent">WellMind Zone</h3>
            <p className="text-[1rem]">
              Revolutionizing mental healthcare management with cutting-edge technology and compassionate care.
            </p>
        ...
        <div className="mt-8 pt-6 border-t border-gray-700 text-center text-sm">
          <p>© {currentYear} WellMind Zone. All rights reserved.</p>
          <p className="mt-2 flex items-center justify-center">
            Made with <FaHeart className="text-accent mx-1" /> by our Team
          </p>
        </div>
      </div>
    </footer>
